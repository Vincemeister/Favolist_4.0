...
# i = 0
# CSV.foreach(people_csv, headers: :first_row, header_converters: :symbol, encoding: 'utf-8') do |row|
#   puts "----------------- ROW #{i} -----------------"
#   user = User.create!(
...
#   user.save!
# end
# CSV.foreach(sugg_people_csv, headers: :first_row, header_converters: :symbol, encoding: 'utf-8') do |row|
#   puts "----------------- ROW #{i} -----------------"
#   user = User.create!(
#     username: row[:profile],
#     bio: row[:bio],
